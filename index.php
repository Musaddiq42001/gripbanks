...
<html lang="en">
  <head>
    ...
    <style type="text/css">
      body{
	      background-image:url("banks1.jpg") ;
        ...
        <h3 class="action" ><center><span style="font-family: 'Roboto Slab', serif">CHOOSE AN ACTION</h3></span></center>
          <div class="column activity text-center">
            <div class="col-md act">
              ...
              <br>
              <br>
              <a href="history.php"><button>Money Transfer History</button></a>
            </div>
            <div class="col-md act">
              <br>
              <br>
              <br>
              <a href="transfermoney.php"><button> Customers Whom to Transfer</button></a>
            </div>
